...
ensure_tar_contains("runseal-aarch64-apple-darwin.tar.gz", "runseal")
ensure_tar_contains("runseal-x86_64-apple-darwin.tar.gz", "runseal")
ensure_zip_contains("runseal-x86_64-pc-windows-msvc.zip", "runseal.exe")
PY
}
...
case "$MODE" in
  accept)
    ...
    require_file runseal-aarch64-apple-darwin.tar.gz
    require_file runseal-x86_64-apple-darwin.tar.gz
    require_file runseal-x86_64-pc-windows-msvc.zip
    ...
    for asset in \
      runseal-x86_64-unknown-linux-gnu.tar.gz \
      runseal-aarch64-apple-darwin.tar.gz \
      runseal-x86_64-apple-darwin.tar.gz \
      runseal-x86_64-pc-windows-msvc.zip
    do
