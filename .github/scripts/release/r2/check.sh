...
for name in RUNSEAL_RELEASES_S3_AK RUNSEAL_RELEASES_S3_SK RUNSEAL_RELEASES_S3_BUCKET RUNSEAL_RELEASES_S3_URL RUNSEAL_RELEASES_PUBLIC_URL RELEASE_CHANNEL R2_ACCESS_PROBE_NAME RUNNER_TEMP GITHUB_RUN_ID GITHUB_SHA; do
  if [ -z "${!name:-}" ]; then
